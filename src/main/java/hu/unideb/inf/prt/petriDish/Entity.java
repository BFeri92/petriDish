...
public class Entity {
	...
	{
		return Math.pow((this.xPos-other.xPos), 2) + Math.pow((this.yPos-other.yPos), 2); 
	}
	
	public boolean colides(Entity other)
	{
		if (distanceSquared(other)<2*radiusSquared) return true; else return false; //we use 50 as radius
	}
}
