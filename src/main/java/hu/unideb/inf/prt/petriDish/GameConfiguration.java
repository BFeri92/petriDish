...
public class GameConfiguration {
	...
	/**
	 * Returns the number of neurons in the hidden layer of an agents neural network.
	 * All of these layers have the same number of neurons.
	 * @return
	 */
	@XmlElement(required=true, nillable=false)
	...
	/**
	 * Sets the number of neurons in the hidden layer of an agents neural network.
	 * All of these layers have the same number of neurons.
	...
	/**
	 * Returns the number of agents which take part in the creation of the next generation of agents.
	 * @return
	 */
	@XmlElement(required=true, nillable=false)
	...
	/**
	 * Sets the number of agents which take part in the creation of the next generation of agents.
	 * @param winnerCount
	 */
	...
	/**
	 * Returns if the new agents should be created by combining the genotype of winner agents.
	 * If recombination is disabled, the agents can only evolve by mutation. 
	 * @return
	 */
	@XmlElement(required=true, nillable=false)
	...
	/**
	 * Returns the variance of mutation.
	 * If mutation occurs, it modify the number describing the gene as G'=G+norm(0, variance),
	 * where norm(m,v) returns a random number from Gaussian distribution with m mean and v variance.
	 * @return 
	 */
	@XmlElement(required=true, nillable=false)
